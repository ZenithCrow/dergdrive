...
pub fn fromChunk(chunk: Chunk) KeyXchgChunk {
    return .{
        ...
        .pub_sign_key = chunk.data[crypt.KeyxchAlgo.public_length .. crypt.KeyxchAlgo.public_length + crypt.SignAlgo.Signature.encoded_length],
        .signature = chunk.data[crypt.KeyxchAlgo.public_length + crypt.SignAlgo.Signature.encoded_length .. content_size],
    };
}
